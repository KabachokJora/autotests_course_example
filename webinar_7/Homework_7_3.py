...
class PublicTransport:
    ...
    def info(self):
        ...
        :return: Строка, с информацией о: марке, цвете, годе выпуска и мощности двигателя транспортного средства
        """
...
class Bus(PublicTransport):
    ...
    def park(self, park):
        """
        Присвоение парку номера
        :param park: номер парка
        :return:
        """
        assert park in range(1000, 10000)
        self.__park = park
