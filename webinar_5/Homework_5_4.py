...
def scrabble(word):
    """
    Высчитывает итоговую стоимость слова в зависимости от цены каждого символа
    :param word: строка, стоимость элементов которой нужно посчитать
    :return: итоговая стоимость слова
    """
    point = {1: ['а', 'в', 'е', 'ё', 'и', 'н', 'о', 'р', 'с', 'т'],
             2: ['д', 'к', 'л', 'м', 'п', 'у'],
             3: ['б', 'г', 'ь', 'я'],
             4: ['й', 'ы'],
             5: ['ж', 'з', 'х', 'ц', 'ч'],
