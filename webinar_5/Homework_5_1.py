...
def letter_stat(our_str):
    """
    Преобразует строку в словарь и подсчитывает кол-во вхождений каждого элемента в строку
    :param our_str: строка, в которой ведем подсчет элементов
    :return: словарь вида: {элемент: кол-во вхождений элемента в строку}
    """
