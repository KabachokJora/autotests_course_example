...
def segment(dot1: tuple, dot2: tuple):
    ...
    :param dot1: координаты первой точки
    :param dot2: координаты второй точки
    :return: Сумма всех координат, или текст исключения задом наперед
    """
    try:
        sum_tuples = dot1[0] + dot1[1] + dot2[0] + dot2[1]
